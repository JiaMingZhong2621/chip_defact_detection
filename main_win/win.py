...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/icon/chip.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-radius:0px;}")
        ...
        self.label_7.setPixmap(QtGui.QPixmap(":/img/icon/chip.png"))
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "芯片缺陷检测界面"))
        self.label_4.setText(_translate("mainWindow", "芯片缺陷检测界面"))
